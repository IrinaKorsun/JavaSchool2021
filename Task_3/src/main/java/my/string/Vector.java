...
public class Vector {
    ...
    public static void main (String [] args) {
        ...
        Vector testVector1 = new Vector(a);
        Vector testVector2 = new Vector(a1);

        System.out.println("Базовый массив " + Arrays.toString(a));
        System.out.println("Метод вычисления длины вектора " + testVector1.lengthVector(a));
        System.out.println("Метод вычисления скалярного произведения векторов " + testVector1.scalarVector(testVector2));
        System.out.println("Метод вычисления векторного произведения с другим вектором " + Arrays.toString(testVector1.multVector(testVector2)));
        System.out.println("Метод вычисляющий угол между векторами или косинус угла " + testVector1.angleVector(testVector2));
        System.out.println("Метод суммы двух векторов " + Arrays.toString(testVector1.sumVector(testVector2)));
        System.out.println("Метод разности двух векторов " + Arrays.toString(testVector1.diffVector(testVector2)));
        System.out.println("Метод заполнения N-массива случайными данными " + Arrays.toString(Vector.randomVector()));
    }
}
