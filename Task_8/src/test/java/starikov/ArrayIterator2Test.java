...
class ArrayIterator2Test {

    String[][] emptyArr = {{}, {}, {}};
    Integer[][] arrWithEmpty = {{}, {1, 2, 3}, {3, 4}};
    Integer[][] array = {{5, 7, 3, 17}, {7, 0, 1, 12}, {8, 1, 2, 3}, {1, 2}};

    ArrayIterator2<String> emptyArrIter = new ArrayIterator2<>(emptyArr);
    ArrayIterator2<Integer> arrWithEmptyIter = new ArrayIterator2<>(arrWithEmpty);
    ArrayIterator2<Integer> arrayIter = new ArrayIterator2<>(array);
