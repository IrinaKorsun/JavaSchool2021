...
public class TestClassDoAfterAll {
    @Test

    public void mainTestMethod() {
        Exception exception = assertThrows(RuntimeException.class, () -> MyAnnotationTest.start(TestClassDoAfterAll.class));
        assertEquals("Ошибка! Методов с аннотацией @DoAfterAll более одного", exception.getMessage());
    }
